...
export const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    footer: { newsletter: { title: "Newsletter", description: "Mantente informado sobre nuestras novedades", placeholder: "Tu email", subscribe: "Suscribirse" }, company: { title: "Horse Truck Garage", description: "Tu especialista francés en transporte ecuestre desde 2008." }, contact: { title: "Contacto", phone: "06 12 34 56 78", email: "contact@horsetruckgarage.fr", address: "123 Route des Chevaux, 75000 Paris", hours: "Lunes a viernes 9h-18h" }, vehicles: { title: "Vehículos", horseTrucks: "Camiones para Caballos", horseVans: "Furgones para Caballos", horseTrailers: "Remolques para Caballos", occasions: "Vehículos Usados" }, company2: { title: "Empresa", about: "Acerca de", contact: "Contacto", blog: "Blog", career: "Carreras" }, followUs: "Síguenos", copyright: "© 2024 Horse Truck Garage. Todos los derechos reservados.", terms: "Términos y condiciones", privacy: "Política de privacidad", sitemap: "Mapa del sitio" },
