...
interface Translations {
  ...
  trust: {
    ...
    title: string;
    subtitle: string;
    stats: { sold: { number: string; label: string; }; satisfied: { number: string; label: string; }; years: { number: string; label: string; }; locations: { number: string; label: string; }; };
...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    trust: {
      ...
      stats: { sold: { number: "2,500+", label: "Véhicules vendus" }, satisfied: { number: "98%", label: "Clients satisfaits" }, years: { number: "15", label: "Années d'expérience" }, locations: { number: "5", label: "Points de vente" } },
      cta: { title: "Prêt à nous faire confiance ?", description: "Contactez nos experts pour une consultation personnalisée.", button: "Demander un Devis" }
    },
    offers: {
      title: "Nos Offres",
      subtitle: "Exclusives",
  ...
  en: {
    ...
    hero: {
      ...
      slide5: { subtitle: "Certified Used Vehicles", title: "Guaranteed Used Vehicles", description: "Discover our rigorous selection of used vehicles." },
      cta: "Get Free Quote"
    },
    categories: {
      title: "Our Vehicles",
      subtitle: "Equestrian",
      horseTrucks: { title: "Horse Trucks", description: "Spacious and comfortable vehicles", features: ["2-6 horse capacity", "Tack compartment"], from: "From", explore: "Explore Trucks" },
      ...
      ctaDescription: "Our experts guide you in choosing the perfect vehicle.",
      ...
      disciplineDescription: "We have the vehicle suited to your passion."
    },
    trust: {
      badge: "Trust",
      title: "Your Trusted Partner",
      subtitle: "Over 15 years of expertise in equestrian transport",
      stats: { sold: { number: "2,500+", label: "Vehicles sold" }, satisfied: { number: "98%", label: "Satisfied customers" }, years: { number: "15", label: "Years of experience" }, locations: { number: "5", label: "Sales points" } },
      cta: { title: "Ready to trust us?", description: "Contact our experts for a personalized consultation.", button: "Get Quote" }
    },
    offers: {
      title: "Our Offers",
      subtitle: "Exclusive",
      tabs: { new: "New Vehicles", used: "Used", financing: "Financing" },
      new: { badge: "New", title: "2024 New Vehicles", description: "Discover the latest innovations", features: ["Manufacturer warranty", "Cutting-edge technologies", "Customization"], cta: "See New Vehicles" },
      used: { badge: "Certified", title: "Guaranteed Used", description: "Inspected and guaranteed vehicles", benefits: ["Technical inspection", "12-month warranty", "0% financing"], cta: "Browse Used Vehicles" },
      financing: { badge: "Facility", title: "Financing Solutions", description: "Options adapted to your budget", details: ["Preferential rates", "Flexible down payment", "24h response"], cta: "Simulate Financing" }
    },
    devisPage: {
      title: "Quote Request",
      subtitle: "Free & Personalized",
      description: "Receive your personalized quote in minutes. Our experts analyze your needs to offer you the perfect solution.",
      vehicleTypes: {
        title: "Vehicle Type",
        subtitle: "Select the type that interests you",
        popular: "Popular",
      ...
      form: {
        ...
        subtitle: "To receive your personalized quote",
        personalInfo: { title: "Personal Information", firstName: "First Name", lastName: "Last Name", email: "Email", phone: "Phone", region: "Region" },
        vehicleRequirements: { title: "Vehicle Requirements", vehicleType: "Vehicle type", horseCapacity: "Horse capacity", condition: "Condition", budget: "Budget", selectVehicleType: "Select a type", selectCapacity: "Number of horses", selectCondition: "New or used", selectBudget: "Your budget" },
        usage: { title: "Usage", primaryUse: "Primary use", equipment: "Desired equipment", selectUsage: "Select usage" },
        additional: { title: "Additional Information", timeline: "Desired timeline", message: "Message", selectTimeline: "When do you want to buy?", messagePlaceholder: "Describe your specific needs..." },
        submit: { title: "Receive my Quote", description: "Response guaranteed within 24h by an expert", button: "Send my Request", disclaimer: "By submitting this form, you agree to be contacted by our teams." }
      }
    },
    trucksPage: {
      title: "Horse Trucks",
      subtitle: "Professional",
      description: "Discover our selection of horse trucks for professional transport and high-level equestrian.",
      ...
      vehicle: {
        ...
        badges: { "bestseller": "Bestseller", "premium": "Premium", "promotion": "Promotion", "certifiedUsed": "Certified Used", "recent": "Recent", "reliable": "Reliable" },
        specs: { horses: "horses", year: "Year", km: "km", capacity: "Capacity" },
        pricing: { save: "Save", financing: "Financing available from", perMonth: "/month" },
        actions: { seeDetails: "See Details", addToFavorites: "Add to favorites" }
      },
    ...
    contactPage: {
      ...
      contactMethods: {
        ...
        appointment: {
          ...
          subtitle: "Personalized appointment",
      ...
      services: {
        ...
        advice: {
          ...
          description: "A to Z support for your project",
          duration: "1h"
        }
      },
      form: {
    ...
    vansPage: {
      ...
      cta: {
        ...
        description: "Our experts guide you in choosing the perfect van.",
        getQuote: "Get Free Quote",
        contactExpert: "Contact Expert"
      }
    },
    footer: {
      newsletter: { title: "Newsletter", description: "Stay informed about our news", placeholder: "Your email", subscribe: "Subscribe" },
      company: { title: "Horse Truck Garage", description: "Your equestrian transport specialist for over 15 years." },
      contact: { title: "Contact", phone: "06 12 34 56 78", email: "contact@horsetruckgarage.fr", address: "123 Route des Chevaux, 75000 Paris", hours: "Mon-Fri 9am-6pm" },
      vehicles: { title: "Vehicles", horseTrucks: "Horse Trucks", horseVans: "Horse Vans", horseTrailers: "Horse Trailers", occasions: "Used Vehicles" },
      company2: { title: "Company", about: "About", contact: "Contact", blog: "Blog", career: "Careers" },
      followUs: "Follow us",
  ...
  es: {
    ...
    hero: {
      slide1: { subtitle: "Transporte Ecuestre Premium", title: "Vehículos Excepcionales para sus Caballos", description: "Descubra nuestra gama completa de camiones, furgones y remolques." },
      slide2: { subtitle: "Comodidad y Seguridad", title: "Camiones para Caballos de Alta Gama", description: "Vehículos espaciosos equipados con las últimas tecnologías." },
      slide3: { subtitle: "Movilidad Óptima", title: "Furgones para Caballos Versátiles", description: "Soluciones prácticas y elegantes para el transporte de 1 a 3 caballos." },
      slide4: { subtitle: "Flexibilidad Máxima", title: "Remolques para Caballos Profesionales", description: "Amplia gama de remolques adaptados a todas sus necesidades." },
      slide5: { subtitle: "Ocasiones Certificadas", title: "Vehículos de Ocasión Garantizados", description: "Descubra nuestra rigurosa selección de vehículos de ocasión." },
      cta: "Solicitar Presupuesto Gratuito"
    },
    categories: {
      title: "Nuestros Vehículos",
      subtitle: "Ecuestres",
      horseTrucks: { title: "Camiones para Caballos", description: "Vehículos espaciosos y cómodos", features: ["Capacidad 2-6 caballos", "Compartimento para aperos"], from: "Desde", explore: "Explorar Camiones" },
      horseVans: { title: "Furgones para Caballos", description: "Soluciones compactas y versátiles", features: ["Formato compacto", "Conducción con carnet B"], from: "Desde", explore: "Explorar Furgones" },
      horseTrailers: { title: "Remolques para Caballos", description: "Remolques robustos y fiables", features: ["1-4 plazas para caballos", "Suelo antideslizante"], from: "Desde", explore: "Explorar Remolques" },
      ctaTitle: "¿Necesita ayuda para elegir?",
      ctaDescription: "Nuestros expertos le guían en la elección del vehículo perfecto.",
      ...
      disciplineDescription: "Tenemos el vehículo adaptado a su pasión."
    },
    trust: {
      badge: "Confianza",
      title: "Su Socio de Confianza",
      subtitle: "Más de 15 años de experiencia en transporte ecuestre",
      stats: { sold: { number: "2,500+", label: "Vehículos vendidos" }, satisfied: { number: "98%", label: "Clientes satisfechos" }, years: { number: "15", label: "Años de experiencia" }, locations: { number: "5", label: "Puntos de venta" } },
      cta: { title: "¿Listo para confiar en nosotros?", description: "Contacte a nuestros expertos para una consulta personalizada.", button: "Solicitar Presupuesto" }
    },
    offers: {
      title: "Nuestras Ofertas",
      subtitle: "Exclusivas",
      tabs: { new: "Vehículos Nuevos", used: "Ocasión", financing: "Financiación" },
      new: { badge: "Novedad", title: "Vehículos Nuevos 2024", description: "Descubra las últimas innovaciones", features: ["Garantía del fabricante", "Tecnologías de vanguardia", "Personalización"], cta: "Ver Novedades" },
      used: { badge: "Certificado", title: "Ocasiones Garantizadas", description: "Vehículos inspeccionados y garantizados", benefits: ["Control técnico", "Garantía 12 meses", "Financiación 0%"], cta: "Explorar Ocasiones" },
      financing: { badge: "Facilidad", title: "Soluciones de Financiación", description: "Opciones adaptadas a su presupuesto", details: ["Tipos preferenciales", "Entrada flexible", "Respuesta 24h"], cta: "Simular Financiación" }
    },
    devisPage: {
      title: "Solicitud de Presupuesto",
      subtitle: "Gratuito y Personalizado",
      description: "Reciba su presupuesto personalizado en minutos. Nuestros expertos analizan sus necesidades para ofrecerle la solución perfecta.",
      vehicleTypes: {
        title: "Tipo de Vehículo",
        subtitle: "Seleccione el tipo que le interesa",
        popular: "Popular",
      ...
      form: {
        ...
        subtitle: "Para recibir su presupuesto personalizado",
        personalInfo: { title: "Información Personal", firstName: "Nombre", lastName: "Apellidos", email: "Email", phone: "Teléfono", region: "Región" },
        vehicleRequirements: { title: "Necesidades del Vehículo", vehicleType: "Tipo de vehículo", horseCapacity: "Capacidad caballos", condition: "Estado", budget: "Presupuesto", selectVehicleType: "Seleccione un tipo", selectCapacity: "Número de caballos", selectCondition: "Nuevo o usado", selectBudget: "Su presupuesto" },
        usage: { title: "Uso", primaryUse: "Uso principal", equipment: "Equipamiento deseado", selectUsage: "Seleccione el uso" },
        additional: { title: "Información Adicional", timeline: "Plazo deseado", message: "Mensaje", selectTimeline: "¿Cuándo desea comprar?", messagePlaceholder: "Describa sus necesidades específicas..." },
        submit: { title: "Recibir mi Presupuesto", description: "Respuesta garantizada en 24h por un experto", button: "Enviar mi Solicitud", disclaimer: "Al enviar este formulario, acepta ser contactado por nuestros equipos." }
      }
    },
    trucksPage: {
      title: "Camiones para Caballos",
      subtitle: "Profesionales",
      description: "Descubra nuestra selección de camiones para caballos para transporte profesional y ecuestre de alto nivel.",
      filters: { allFilters: "Todos los filtros", capacity: "Capacidad", price: "Precio", year: "Año", mileage: "Kilometraje", found: "camiones encontrados" },
      vehicle: {
        horseTruck: "Camión para Caballos",
        features: {},
        badges: { "bestseller": "Más vendido", "premium": "Premium", "promotion": "Promoción", "certifiedUsed": "Ocasión Certificada", "recent": "Reciente", "reliable": "Fiable" },
        specs: { horses: "caballos", year: "Año", km: "km", capacity: "Capacidad" },
        pricing: { save: "Ahorrar", financing: "Financiación desde", perMonth: "/mes" },
        actions: { seeDetails: "Ver Detalles", addToFavorites: "Añadir a favoritos" }
      },
      cta: { title: "¿Necesita Consejos sobre nuestros Camiones?", description: "Nuestros expertos le acompañan en la elección del camión perfecto.", getQuote: "Solicitar Presupuesto", contactExpert: "Contactar Experto" }
    },
    aboutPage: {},
    contactPage: {
      hero: {
        ...
        description: "Nuestro equipo de expertos está a su disposición para acompañarle en su proyecto de transporte ecuestre."
      },
      methodsSection: {
        title1: "¿Cómo ",
        title2: "Contactarnos?",
        subtitle: "Varios métodos de comunicación están disponibles para usted"
      },
      contactMethods: {
        phone: {
          title: "Por Teléfono",
          subtitle: "06 12 34 56 78",
          description: "Llámenos directamente para un consejo inmediato",
          action: "tel:+33612345678",
        ...
        chat: {
          title: "Chat en Línea",
          subtitle: "Disponible 9h-18h",
          description: "Chatea en directo con uno de nuestros asesores",
          action: "#",
        ...
        appointment: {
          ...
          description: "Planifique una visita o llamada con un experto",
          action: "#",
          actionText: "Reservar Horario"
        }
      },
      contactInfo: {
        title1: "Nuestros ",
        title2: "Datos de Contacto",
        subtitle: "Encuentre toda nuestra información práctica",
        address: {
          title: "Dirección",
          street: "123 Route des Chevaux\n75000 París",
          city: "Francia"
      ...
      services: {
        ...
        expertise: {
          ...
          description: "Asistencia personalizada para elegir su vehículo",
          duration: "30 min"
        },
        financing: {
          title: "Soluciones de Financiación",
          description: "Estudio gratuito de sus opciones de financiación",
          duration: "45 min"
        },
        advice: {
          title: "Seguimiento Personalizado",
          description: "Acompañamiento de A a Z en su proyecto",
          duration: "1h"
        }
      },
      form: {
        title: "Escríbanos",
        subtitle: "Envíenos un mensaje y le responderemos rápidamente",
        fields: {
          firstName: "Nombre",
          lastName: "Apellidos",
          email: "Email",
        ...
        placeholders: {
          firstName: "Su nombre",
          lastName: "Sus apellidos",
          email: "su@email.com",
          phone: "06 12 34 56 78",
          vehicleTypeSelect: "Seleccione un tipo",
          budgetSelect: "Seleccione su presupuesto",
        ...
        submitSubtitle: "Nuestro equipo le contactará rápidamente",
    ...
    vansPage: {
      ...
      description: "Descubra nuestra selección de furgones para caballos, perfectos para el transporte de 1 a 3 caballos con carnet B.",
      filters: {
      ...
      cta: {
        title: "¿Necesita Consejos sobre nuestros Furgones?",
        description: "Nuestros expertos le acompañan en la elección del furgón perfecto.",
        getQuote: "Solicitar Presupuesto",
        contactExpert: "Contactar Experto"
      }
    },
    footer: {
      newsletter: { title: "Newsletter", description: "Manténgase informado de nuestras noticias", placeholder: "Su email", subscribe: "Suscribirse" },
      company: { title: "Horse Truck Garage", description: "Su especialista en transporte ecuestre durante más de 15 años." },
      contact: { title: "Contacto", phone: "06 12 34 56 78", email: "contact@horsetruckgarage.fr", address: "123 Route des Chevaux, 75000 París", hours: "Lun-Vie 9h-18h" },
      vehicles: { title: "Vehículos", horseTrucks: "Camiones para Caballos", horseVans: "Furgones para Caballos", horseTrailers: "Remolques para Caballos", occasions: "Ocasiones" },
      company2: { title: "Empresa", about: "Acerca de", contact: "Contacto", blog: "Blog", career: "Carreras" },
      followUs: "Síguenos",
  ...
  de: {
    ...
    hero: {
      slide1: { subtitle: "Premium Pferdetransport", title: "Außergewöhnliche Fahrzeuge für Ihre Pferde", description: "Entdecken Sie unser komplettes Sortiment an LKWs, Vans und Anhängern." },
      slide2: { subtitle: "Komfort & Sicherheit", title: "High-End Pferdetransporter", description: "Geräumige Fahrzeuge mit neuester Technologie ausgestattet." },
      slide3: { subtitle: "Optimale Mobilität", title: "Vielseitige Pferde-Vans", description: "Praktische und elegante Lösungen für den Transport von 1 bis 3 Pferden." },
      slide4: { subtitle: "Maximale Flexibilität", title: "Professionelle Pferdeanhänger", description: "Breite Palette von Anhängern für alle Ihre Bedürfnisse." },
      slide5: { subtitle: "Zertifizierte Gebrauchtwagen", title: "Garantierte Gebrauchtwagen", description: "Entdecken Sie unsere sorgfältige Auswahl an Gebrauchtwagen." },
      cta: "Kostenloses Angebot erhalten"
    },
    categories: {
      title: "Unsere Fahrzeuge",
      subtitle: "Reitsport",
      horseTrucks: { title: "Pferdetransporter", description: "Geräumige und komfortable Fahrzeuge", features: ["2-6 Pferde Kapazität", "Sattelkammer"], from: "Ab", explore: "LKWs erkunden" },
      horseVans: { title: "Pferde-Vans", description: "Kompakte und vielseitige Lösungen", features: ["Kompaktes Format", "B-Führerschein"], from: "Ab", explore: "Vans erkunden" },
      horseTrailers: { title: "Pferdeanhänger", description: "Robuste und zuverlässige Anhänger", features: ["1-4 Pferdeplätze", "Rutschfester Boden"], from: "Ab", explore: "Anhänger erkunden" },
      ctaTitle: "Brauchen Sie Hilfe bei der Auswahl?",
      ctaDescription: "Unsere Experten begleiten Sie bei der Wahl des perfekten Fahrzeugs.",
      getFreeQuote: "Kostenloses Angebot",
      makeAppointment: "Termin vereinbaren",
      specialties: "Unsere Spezialitäten",
      findPerfectVehicle: "Finden Sie das perfekte Fahrzeug",
      disciplineDescription: "Wir haben das Fahrzeug für Ihre Leidenschaft."
    },
    trust: {
      badge: "Vertrauen",
      title: "Ihr vertrauensvoller Partner",
      subtitle: "Über 15 Jahre Expertise im Pferdetransport",
      stats: { sold: { number: "2,500+", label: "Verkaufte Fahrzeuge" }, satisfied: { number: "98%", label: "Zufriedene Kunden" }, years: { number: "15", label: "Jahre Erfahrung" }, locations: { number: "5", label: "Verkaufsstellen" } },
      cta: { title: "Bereit, uns zu vertrauen?", description: "Kontaktieren Sie unsere Experten für eine persönliche Beratung.", button: "Angebot anfordern" }
    },
    offers: {
      title: "Unsere Angebote",
      subtitle: "Exklusiv",
      tabs: { new: "Neue Fahrzeuge", used: "Gebraucht", financing: "Finanzierung" },
      new: { badge: "Neu", title: "2024 Neue Fahrzeuge", description: "Entdecken Sie die neuesten Innovationen", features: ["Herstellergarantie", "Modernste Technologien", "Anpassung"], cta: "Neue Fahrzeuge ansehen" },
      used: { badge: "Zertifiziert", title: "Garantierte Gebrauchtwagen", description: "Geprüfte und garantierte Fahrzeuge", benefits: ["Technische Prüfung", "12 Monate Garantie", "0% Finanzierung"], cta: "Gebrauchtwagen durchsuchen" },
      financing: { badge: "Erleichterung", title: "Finanzierungslösungen", description: "An Ihr Budget angepasste Optionen", details: ["Vorzugszinsen", "Flexible Anzahlung", "24h Antwort"], cta: "Finanzierung simulieren" }
    },
    devisPage: {
      title: "Angebotsanfrage",
      subtitle: "Kostenlos & Personalisiert",
      description: "Erhalten Sie Ihr personalisiertes Angebot in Minuten. Unsere Experten analysieren Ihre Bedürfnisse, um Ihnen die perfekte Lösung anzubieten.",
      vehicleTypes: {
        title: "Fahrzeugtyp",
        subtitle: "Wählen Sie den Typ, der Sie interessiert",
        popular: "Beliebt",
      ...
      form: {
        ...
        subtitle: "Um Ihr personalisiertes Angebot zu erhalten",
        personalInfo: { title: "Persönliche Informationen", firstName: "Vorname", lastName: "Nachname", email: "E-Mail", phone: "Telefon", region: "Region" },
        vehicleRequirements: { title: "Fahrzeuganforderungen", vehicleType: "Fahrzeugtyp", horseCapacity: "Pferdekapazität", condition: "Zustand", budget: "Budget", selectVehicleType: "Typ auswählen", selectCapacity: "Anzahl Pferde", selectCondition: "Neu oder gebraucht", selectBudget: "Ihr Budget" },
        usage: { title: "Verwendung", primaryUse: "Hauptverwendung", equipment: "Gewünschte Ausstattung", selectUsage: "Verwendung auswählen" },
        additional: { title: "Zusätzliche Informationen", timeline: "Gewünschter Zeitrahmen", message: "Nachricht", selectTimeline: "Wann möchten Sie kaufen?", messagePlaceholder: "Beschreiben Sie Ihre spezifischen Bedürfnisse..." },
        submit: { title: "Mein Angebot erhalten", description: "Antwort garantiert innerhalb von 24h durch einen Experten", button: "Meine Anfrage senden", disclaimer: "Durch das Absenden dieses Formulars stimmen Sie zu, von unseren Teams kontaktiert zu werden." }
      }
    },
    trucksPage: {
      title: "Pferdetransporter",
      subtitle: "Professionell",
      description: "Entdecken Sie unsere Auswahl an Pferdetransportern für professionellen Transport und Hochleistungsreitsport.",
      filters: { allFilters: "Alle Filter", capacity: "Kapazität", price: "Preis", year: "Jahr", mileage: "Kilometerstand", found: "LKWs gefunden" },
      vehicle: {
        horseTruck: "Pferdetransporter",
        features: {},
        badges: { "bestseller": "Bestseller", "premium": "Premium", "promotion": "Aktion", "certifiedUsed": "Zertifiziert Gebraucht", "recent": "Aktuell", "reliable": "Zuverlässig" },
        specs: { horses: "Pferde", year: "Jahr", km: "km", capacity: "Kapazität" },
        pricing: { save: "Sparen", financing: "Finanzierung ab", perMonth: "/Monat" },
        actions: { seeDetails: "Details ansehen", addToFavorites: "Zu Favoriten hinzufügen" }
      },
      cta: { title: "Brauchen Sie Beratung zu unseren LKWs?", description: "Unsere Experten begleiten Sie bei der Wahl des perfekten LKWs.", getQuote: "Kostenloses Angebot", contactExpert: "Experten kontaktieren" }
    },
    aboutPage: {},
    contactPage: {
      hero: {
      ...
      methodsSection: {
        title1: "Wie können Sie ",
        title2: "uns kontaktieren?",
        subtitle: "Verschiedene Kommunikationswege stehen Ihnen zur Verfügung"
      },
      contactMethods: {
        phone: {
          title: "Per Telefon",
      ...
      services: {
        ...
        advice: {
          ...
          description: "Von A bis Z Unterstützung für Ihr Projekt",
          duration: "1h"
        }
      },
      form: {
        ...
        placeholders: {
          ...
          budgetSelect: "Ihr Budget auswählen",
        ...
        submitSubtitle: "Unser Team wird Sie schnell kontaktieren",
    ...
    vansPage: {
      ...
      cta: {
        ...
        description: "Unsere Experten begleiten Sie bei der Wahl des perfekten Vans.",
        getQuote: "Kostenloses Angebot",
        contactExpert: "Experten kontaktieren"
      }
    },
    footer: {
      newsletter: { title: "Newsletter", description: "Bleiben Sie über unsere Neuigkeiten informiert", placeholder: "Ihre E-Mail", subscribe: "Abonnieren" },
      company: { title: "Horse Truck Garage", description: "Ihr Spezialist für Pferdetransport seit über 15 Jahren." },
      contact: { title: "Kontakt", phone: "06 12 34 56 78", email: "contact@horsetruckgarage.fr", address: "123 Route des Chevaux, 75000 Paris", hours: "Mo-Fr 9-18 Uhr" },
      vehicles: { title: "Fahrzeuge", horseTrucks: "Pferdetransporter", horseVans: "Pferde-Vans", horseTrailers: "Pferdeanhänger", occasions: "Gebrauchtwagen" },
      company2: { title: "Unternehmen", about: "Über uns", contact: "Kontakt", blog: "Blog", career: "Karriere" },
