...
export interface Translations {
  ...
  footer: {
    ...
    services: { title: string; financing: string; insurance: string; warranty: string; maintenance: string; };
    followUs: string;
    copyright: string;
    terms: string;
    privacy: string;
...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    footer: {
      ...
      services: { title: "Services", financing: "Financement", insurance: "Assurance", warranty: "Garantie", maintenance: "Maintenance" },
