        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="block text-foreground">Transport Équin</span>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center lg:text-left">
                ...
                <div className="text-muted-foreground">Véhicules Vendus</div>
              </div>
              <div className="text-center lg:text-left">
          ...
          <div className="relative animate-slide-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 htg-card p-4 w-48">
                <div className="text-center">
