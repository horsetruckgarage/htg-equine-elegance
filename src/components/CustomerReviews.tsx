          ...
          <div className="htg-card max-w-2xl mx-auto p-8">
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="https://www.google.com/search?q=HTG+Horse+Truck+Garage+avis" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="htg-button-primary inline-flex items-center justify-center px-6 py-3 rounded-lg"
                >
